<template>
  <nav class="h-16 flex items-center bg-purple-200 justify-between px-4 shadow-md  fixed top-0 left-0 right-0 z-50">
    <!-- Logo -->
    <div class="text-xl font-bold ml-15 text-shadow-md">SOR CHHIN</div>
